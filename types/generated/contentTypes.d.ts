...
export interface ApiAbodyyyAbodyyy extends Schema.CollectionType {
  collectionName: 'abodyyys';
  info: {
    singularName: 'abodyyy';
    pluralName: 'abodyyys';
    displayName: 'abodyyy';
  };
  options: {
...
export interface ApiAtooofAtooof extends Schema.CollectionType {
  collectionName: 'atooofs';
  info: {
    singularName: 'atooof';
    pluralName: 'atooofs';
    displayName: 'atooof';
...
export interface ApiAuthonticationAuthontication extends Schema.CollectionType {
  collectionName: 'authontications';
  info: {
    singularName: 'authontication';
    pluralName: 'authontications';
    displayName: 'authontication';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::authontication.authontication',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiMangaaMangaa extends Schema.CollectionType {
  collectionName: 'mangaas';
  info: {
    singularName: 'mangaa';
    pluralName: 'mangaas';
    displayName: 'mangaa';
